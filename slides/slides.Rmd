...
the condition turns three unknowns into one scalar equation in $\chi$, and that order is what
keeps every root-find in this model one-dimensional and monotone.
]
]
