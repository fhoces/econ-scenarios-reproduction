...
.pull-left[
.opa-compare-fig[
<img src="../assets/opa/opa-compare-original.svg" alt="The original analysis: output and details layers, offset and disconnected, with an empty outline where materials would be">
]
.opa-compare-cap[
...
.pull-right[
.opa-compare-fig[
<img src="../assets/opa/opa-compare-opa.svg" alt="This OPA: output, details and materials stacked tightly in one plane">
]
.opa-compare-cap[
...
.opa-compare-lead { font-size: 88%; margin: -4px 0 10px; }
.opa-compare-fig img { display: block; height: 285px; width: auto; margin: 0 auto; }
.opa-compare-cap { font-size: 78%; line-height: 1.35; margin-top: 6px; }
...
<tr><td style="padding:6px;"><b>1. The claim</b></td><td style="padding:6px;">What the paper asserts, and the seven inputs it rests on</td><td style="text-align:center;">5&ndash;19</td></tr>
<tr><td style="padding:6px;"><b>2. The model</b></td><td style="padding:6px;">Task-based production, the assignment rule, prices and shares, TFP, the labor share, employment, ideas, unemployment: where every equation comes from</td><td style="text-align:center;">20&ndash;35</td></tr>
<tr><td style="padding:6px;"><b>3. Solving the model for US inputs</b></td><td style="padding:6px;">Calibration, the steady state, all 44 equations and the order they run in, the root-finds</td><td style="text-align:center;">36&ndash;49</td></tr>
<tr><td style="padding:6px;"><b>4. Results: some scenarios and the explorer</b></td><td style="padding:6px;">The three scenarios one at a time, robustness, the survey, what reproduces, takeaways, and two postscripts (the whole grid, AI slop)</td><td style="text-align:center;">50&ndash;62</td></tr>
<tr><td style="padding:6px;"><b>Backup</b></td><td style="padding:6px;">A CES refresher, solving the steady state, month 0 step by step, the 44 equations in the code, five derivations, matching, why slop flips the wage, the pool rounding, growth against levels, the gain <i>a</i></td><td style="text-align:center;">63&ndash;82</td></tr>
</table>
