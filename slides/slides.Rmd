...
rather than replacing them" means lowering $\psi$, not raising some other input. Over $\psi$ from 0
to 1, wider than any scenario uses (pure augmentation to pure automation), measured TFP moves only
