...
.opa-legend[
**Open Output**: [the explorer](../explorer/), every combination of the seven inputs<br>
...
<tr><td style="padding:6px;"><b>4. Results: some scenarios and the explorer</b></td><td style="padding:6px;">The three scenarios one at a time, robustness, the survey, what reproduces, and the whole grid</td><td style="text-align:center;">49&ndash;61</td></tr>
<tr><td style="padding:6px;"><b>Backup</b></td><td style="padding:6px;">Derivations, month 0 step by step, the gain <i>a</i>, the slop extension</td><td style="text-align:center;">62&ndash;81</td></tr>
</table>
...
do. Grid caveat: every cell builds $a_t$ from the substantial scenario's mid-2026 anchor (0.35), as
the paper's explorer does for custom gains above it, so the grid's corners reproduce this
reproduction's runs of the named scenarios to within 0.03 points.
]
...
# Backup: The Two Cells That Need a Wider Tolerance
...
5 and 6 that need the test tolerance widened (to 0.09 points).

At $\bar U = 0.0384$ the all-workers row lands exactly, six further cells that had
rounded to a different last digit fall into line, and nothing else changes materially. The AI-sensitive
