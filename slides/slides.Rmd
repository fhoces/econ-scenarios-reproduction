...
.credit[OPA done by [Fernando Hoces de la Guardia](https://fhoces.github.io), using [agentic coding tools](../index.html#how-ai-was-used)]

---
name: opa-compare

# What This OPA Adds to the Paper

.opa-compare-lead[
Everything of substance here is the authors' work: the model, the calibration, the survey, the
three scenarios and every conclusion in
[Korinek, Jones, Sacher, Cotter and McCrory (2026)](https://www.anthropic.com/institute/econ-scenarios).
This OPA adds one small, important but missing, layer of transparency on top.
]

<div class="opa-fig"><svg class="opa-anim" viewBox="0 0 300 290" role="img" aria-label="The original analysis: output and details layers, offset and disconnected, with an empty outline where a materials layer would be" xmlns="http://www.w3.org/2000/svg"><g transform="translate(208,212)"><g class=""><polygon points="0,-46 92,0 92,26 0,72 -92,26 -92,0" fill="none" stroke="#6b7682" stroke-width="1.5" stroke-dasharray="5 4" opacity="0.55"/><polyline points="-92,0 0,46 92,0" fill="none" stroke="#6b7682" stroke-width="1.5" stroke-dasharray="5 4" opacity="0.55"/></g></g><g transform="translate(208,138)"><g class=""><polygon points="-92,0 0,46 0,72 -92,26" fill="#1581ab"/><polygon points="0,46 92,0 92,26 0,72" fill="#1582b8"/><polygon points="0,-46 92,0 0,46 -92,0" fill="#1484c5"/><text transform="matrix(0.894 -0.447 0 1 46.0 41.7)" text-anchor="middle" font-family="IBM Plex Sans, Segoe UI, sans-serif" font-weight="600" font-size="11" letter-spacing="1.5" fill="#fff">DETAILS</text></g></g><g transform="translate(92,52)"><g class=""><polygon points="-92,0 0,46 0,72 -92,26" fill="#da9516"/><polygon points="0,46 92,0 92,26 0,72" fill="#eca516"/><polygon points="0,-46 92,0 0,46 -92,0" fill="#fcb415"/><text transform="matrix(0.894 -0.447 0 1 46.0 41.7)" text-anchor="middle" font-family="IBM Plex Sans, Segoe UI, sans-serif" font-weight="600" font-size="11" letter-spacing="1.5" fill="#fff">OUTPUT</text></g></g></svg></div>

.opa-compare-cap[
**The paper: two layers, not connected.** It publishes an output (Table 3, its figures, its own
explorer) and the details (45 equations, Table A.1, Appendices A and C), but no code joins
them, so no number can be regenerated or changed.
]

---
name: opa-compare-opa
...
<div class="opa-fig"><svg class="opa-anim" viewBox="0 0 300 290" role="img" aria-label="This OPA: output, details and materials stacked tightly in one plane" xmlns="http://www.w3.org/2000/svg"><g transform="translate(208,212)"><g class="lyr-ghost"><polygon points="0,-46 92,0 92,26 0,72 -92,26 -92,0" fill="none" stroke="#6b7682" stroke-width="1.5" stroke-dasharray="5 4" opacity="0.55"/><polyline points="-92,0 0,46 92,0" fill="none" stroke="#6b7682" stroke-width="1.5" stroke-dasharray="5 4" opacity="0.55"/></g></g><g transform="translate(150,157)"><g class="lyr-mat"><polygon points="-92,0 0,46 0,72 -92,26" fill="#002547"/><polygon points="0,46 92,0 92,26 0,72" fill="#003262"/><polygon points="0,-46 92,0 0,46 -92,0" fill="#0b4a7c"/><text transform="matrix(0.894 -0.447 0 1 46.0 41.7)" text-anchor="middle" font-family="IBM Plex Sans, Segoe UI, sans-serif" font-weight="600" font-size="10" letter-spacing="1.5" fill="#fff">MATERIALS</text></g></g><g transform="translate(150,126)"><g class="lyr-det"><polygon points="-92,0 0,46 0,72 -92,26" fill="#1581ab"/><polygon points="0,46 92,0 92,26 0,72" fill="#1582b8"/><polygon points="0,-46 92,0 0,46 -92,0" fill="#1484c5"/><text transform="matrix(0.894 -0.447 0 1 46.0 41.7)" text-anchor="middle" font-family="IBM Plex Sans, Segoe UI, sans-serif" font-weight="600" font-size="11" letter-spacing="1.5" fill="#fff">DETAILS</text></g></g><g transform="translate(150,86)"><g class="lyr-out"><polygon points="-92,0 0,46 0,72 -92,26" fill="#da9516"/><polygon points="0,46 92,0 92,26 0,72" fill="#eca516"/><polygon points="0,-46 92,0 0,46 -92,0" fill="#fcb415"/><text transform="matrix(0.894 -0.447 0 1 46.0 41.7)" text-anchor="middle" font-family="IBM Plex Sans, Segoe UI, sans-serif" font-weight="600" font-size="11" letter-spacing="1.5" fill="#fff">OUTPUT</text></g></g></svg></div>

.opa-compare-cap[
**This OPA: three layers, tightly connected.** The explorer's numbers come from the code in the
repository, the report and this deck cite the paper's equations by number, and the test suite
...
.opa-compare-lead { font-size: 88%; margin: -4px 0 6px; }
/* opa-compare build: slide B's layers animate from slide A's positions into the stack.
   Offsets are A minus B in SVG user units (one CSS px = one user unit inside the SVG). */
.opa-anim { display: block; height: 330px; width: auto; margin: 4px auto 0; overflow: visible; }
.opa-anim .lyr-ghost { opacity: 0; }
.remark-visible .opa-anim .lyr-out  { animation: opa-out 1s ease-out both; }
.remark-visible .opa-anim .lyr-det  { animation: opa-det 1s ease-out both; }
.remark-visible .opa-anim .lyr-mat  { animation: opa-mat 1s ease-out both; }
.remark-visible .opa-anim .lyr-ghost { animation: opa-ghost 1s ease-out both; }
@keyframes opa-out   { from { transform: translate(-58px, -34px); } to { transform: none; } }
@keyframes opa-det   { from { transform: translate(58px, 12px); } to { transform: none; } }
@keyframes opa-mat   { from { transform: translate(58px, 55px); opacity: 0; }
                        60% { opacity: 0.6; } to { transform: none; opacity: 1; } }
@keyframes opa-ghost { from { opacity: 1; } to { opacity: 0; } }
@media print { .opa-anim g { animation: none !important; } }
.opa-compare-cap { font-size: 80%; line-height: 1.4; max-width: 760px; margin: 8px auto 0; text-align: center; }
...
<tr><td style="padding:6px;"><b>1. The claim</b></td><td style="padding:6px;">What the paper asserts, and the seven inputs it rests on</td><td style="text-align:center;">6&ndash;20</td></tr>
<tr><td style="padding:6px;"><b>2. The model</b></td><td style="padding:6px;">Task-based production, the assignment rule, prices and shares, TFP, the labor share, employment, ideas, unemployment: where every equation comes from</td><td style="text-align:center;">21&ndash;36</td></tr>
<tr><td style="padding:6px;"><b>3. Solving the model for US inputs</b></td><td style="padding:6px;">Calibration, the steady state, all 44 equations and the order they run in, the root-finds</td><td style="text-align:center;">37&ndash;50</td></tr>
<tr><td style="padding:6px;"><b>4. Results: some scenarios and the explorer</b></td><td style="padding:6px;">The three scenarios one at a time, robustness, the survey, what reproduces, takeaways, and two postscripts (the whole grid, AI slop)</td><td style="text-align:center;">51&ndash;63</td></tr>
<tr><td style="padding:6px;"><b>Backup</b></td><td style="padding:6px;">A CES refresher, solving the steady state, month 0 step by step, the 44 equations in the code, five derivations, matching, why slop flips the wage, the pool rounding, growth against levels, the gain <i>a</i></td><td style="text-align:center;">64&ndash;83</td></tr>
</table>
